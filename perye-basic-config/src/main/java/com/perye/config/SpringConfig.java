...
import com.perye.common.converter.StringToDateConverter;
import com.perye.common.filter.RequestLoggingFilter;
import com.perye.common.interceptor.InjectionAttackInterceptor;
...
public class SpringConfig implements WebMvcConfigurer, ErrorPageRegistrar {
    ...
    @ConditionalOnProperty( prefix = "perye.filter.injection-attack-interceptor", name = "enabled", havingValue = "true" )
