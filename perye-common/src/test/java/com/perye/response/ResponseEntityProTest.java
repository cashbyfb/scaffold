...
public class ResponseEntityProTest {
	...
	@Test
	public void test1() {
		User user = new User().setUsername("perye")
			.setEmail("11143526@qq.com")
			.setNickName("perye")
			.setPhone("15759115153")
			.setPassword("123456")
			.setPasswordSalt("-1")
			.setEnabled(true);
	...
	@Test
	public void test3() {
		final ResponseEntity<Map<String, Object>> ok = new ResponseEntityPro().add("name", "perye")
			.add("password", "123456")
			.buildOk();
