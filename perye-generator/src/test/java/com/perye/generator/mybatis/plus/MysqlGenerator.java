 ...
 * the License.
 */
package com.perye.generator.mybatis.plus;
...
public class MysqlGenerator {
	...
	public static void main ( String[] args ) {
		...
		AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
			// 全局配置
			new GlobalConfig()
				.setOutputDir( "/Users/perye/Desktop" )//输出目录
			...
			new DataSourceConfig()
					...
					.setUsername( "root" )
					.setPassword( "root" )
					.setUrl( "jdbc:mysql://127.0.0.1:3306/perye?characterEncoding=utf8" )
		).setStrategy(
			// 策略配置
			new StrategyConfig()
			...
			new PackageConfig()
				// .setModuleName( "test" )
				.setParent( "com.perye.manage" )// 自定义包路径
